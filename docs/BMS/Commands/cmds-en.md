...
RDM, nazo, nazoZZ, bme2wav, LR2, nanasi, ruvit, fgt++, fgt#, pomu2, uBMplay, PMSee-V, bmx2wav, iBMSC (3.0 or later), Angolmoischannelsame as BMEheader
...
* The display type of POOR (MISS) images is defined.
  ...
  The orthodox type which changes a display to the channel `#xxx06` for several seconds when a mistake is made.
